...
class ModelEvaluation:
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        """
        logger.info("Entered the evaluate_model method of Model evaluation class")
        try:
            ...
            logger.info("splitted the test data into train and test")
            ...
            logger.info("Prediction done with production model")
            ...
            logger.info("Exited the evaluate_model method of Model evaluation class")
            return result
